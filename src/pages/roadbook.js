...
const RoadbookPage = () => (
  <div className="page">
    <div className="roadbook">
      <div className="wrapper pvxl">
        <h1 className="ratherloud-heading">Roadbook</h1>
        <p>
          ...
          after your stay at Web Rebels 2017. Please bookmark this page.
        </p>
        ...
        <p>
          ...
          whole conference. If you have any questions or problems please talk to
          him. You can also contact any of the other organizers at any time
          during your stay.
        </p>
        <p>
        ...
        <a name="travel_to_and_from_the_airport" />
        <h2>Travel to and from the airport</h2>
        <p>
          If you are flying into Oslo you will arrive at and depart from{" "}
          <a href="http://www.osl.no/en/osl">Oslo Airport Gardermoen</a> (OSL).
          Between the airport and Oslo Central Station (nicknamed Oslo S) there
          is a high speed airport shuttle, named Flytoget, running every 10
          minute. The travel time is ~20 minutes. Departures can be{" "}
          <a href="http://www.flytoget.no/eng/">checked here</a>.
        </p>
        <p>
          If you did not receive airport shuttle tickets before departure,
          please purchase one (ticket machines take credit cards) and give it to
          your speaker contact, <a href="#trygve">Trygve Lie</a>, at any time
          during the conference and we will refund it in cash and give you a
        ...
        <a name="the_conference_hotel" />
        <h2>The conference hotel</h2>
        <p>
          Your hotel is the{" "}
        ...
        <p>
          ...
          From Oslo Central Station you can take tram 11, 12 and 13 eastbound to
          Schous Plass (four stops from Oslo Central Station). At Schous Plass
          you can walk{" "}
          <a href="http://goo.gl/maps/h78NN">this short route to the hotel</a>.
        </p>
        <a name="getting_around_in_oslo" />
        <h2>Getting around in Oslo</h2>
        <p>
          Most of you will receive a public transport pass before you depart for
          Oslo. If you have not received one before departure, you will receive
          one when you check into the hotel. If there is not one for you at the
          hotel, please contact <a href="#trygve">Trygve Lie</a> and he will
          give you one.
        </p>
        <p>
          The public transport pass is valid for 7 days from the day it's first
          validated. It is valid for all public busses, trams, subways and boats
          to the islands in the Oslo fjord and some local trains. You should
          validate the card each time you use the public transport system. One
          can validate the card on board busses, trams and boats. On subways and
          trains one need to validate the card before entering.
        </p>
        <p>
        ...
        <a name="speaker_dinner" />
        <h2>Speaker dinner</h2>
        <p>
          At 18:00 on the 31st of May there will be a speaker dinner. Organizers
          will be in the loby of the hotel at 17:45 until 18:00 so you can join
          us there and we walk to the restaurant in a group.
        </p>
        <p>
          If you have a special diet (vegan, vegetarian, allergies, etc.) please
          let us know in advance and we will arrange food which suite your diet.
        </p>
        <p>
          ...
          will be at the V Bar og Bistro which is the bar on the ground floor of
        ...
        <p>
          There will be a section of medium sized tables up front and chairs in
          an auditorium setting behind. The speaker will be at the same level as
          the ground floor. There is no dedicated speaker area at the venue. For
          the speaker there will be a small round table in standing height and
        ...
        <p>
          ...
          know before the conference starts so a cable to connect to the PA can
          be provided for you.
        </p>
        <p>
          On stage there is also a dedicated Internet connection which will not
          interfere with the connection used by the attendees. This connection
          can be used if you need a guaranteed connection to Internet.
        </p>
        <p>
          Norway use{" "}
          <a href="http://www.world-power-plug.com/power-plug/Norway">Type F</a>{" "}
        ...
        <p>
          ...
          powers of knowledge, you and the MC will have a QA session about your
          talk. The QA session will be held in a seated area on stage and will
          last between 5 and 10 minutes. In other words there will not be any
          direct questions from the audience. The MC of 2016 is Max Ogden.
        </p>
        ...
        <a name="filming_and_streaming" />
        <h2>Filming and streaming</h2>
        <p>
          Your talk will be professionally filmed and published on{" "}
          <a href="http://vimeo.com/webrebels">our video channel at Vimeo</a> as
          fast as possible after the conference. All videos published will be
          published under a{" "}
        ...
        <p>
          We will also stream all talks live in full HD. Information about that
          the conference will be streamed will be published the day before the
          conference.
        </p>
        <p>
        ...
        <h2>Side events</h2>
        <p>
          Web Rebels are responsible for arranging a meet-up on the 31st of May
          and a workshop on the 3rd of June. As a speaker you have access to all
          events.
        </p>
      </div>
    </div>
